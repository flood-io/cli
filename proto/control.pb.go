...
func (m *DevtoolsRequest) Reset()                    { *m = DevtoolsRequest{} }
func (m *DevtoolsRequest) String() string            { return proto.CompactTextString(m) }
func (*DevtoolsRequest) ProtoMessage()               {}
func (*DevtoolsRequest) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{0} }

type DevtoolsResponse struct {
	WsEndpoint string `protobuf:"bytes,1,opt,name=wsEndpoint,proto3" json:"wsEndpoint,omitempty"`
}

func (m *DevtoolsResponse) Reset()                    { *m = DevtoolsResponse{} }
func (m *DevtoolsResponse) String() string            { return proto.CompactTextString(m) }
func (*DevtoolsResponse) ProtoMessage()               {}
func (*DevtoolsResponse) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{1} }

func (m *DevtoolsResponse) GetWsEndpoint() string {
	if m != nil {
		return m.WsEndpoint
	}
	return ""
...
func (*TestRequest) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{2} }
...
func (*TestResult) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{3} }
...
func (*TestResult_Log) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{3, 0} }
...
func (*TestResult_Error) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{3, 1} }
...
func (*TestResult_Step) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{3, 2} }
...
func (*TestResult_Complete) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{3, 3} }
...
func (*TestResult_Measurement) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{3, 4} }
...
func (*TestResult_Trace) Descriptor() ([]byte, []int) { return fileDescriptorControl, []int{3, 5} }
...
func (*TestResult_Trace_Network) Descriptor() ([]byte, []int) {
	return fileDescriptorControl, []int{3, 5, 0}
}
...
func (*TestResult_Trace_Screenshot) Descriptor() ([]byte, []int) {
	return fileDescriptorControl, []int{3, 5, 1}
}
...
func init() {
	proto.RegisterType((*DevtoolsRequest)(nil), "floodchrome.DevtoolsRequest")
	proto.RegisterType((*DevtoolsResponse)(nil), "floodchrome.DevtoolsResponse")
...
type TestClient interface {
	...
	Devtools(ctx context.Context, in *DevtoolsRequest, opts ...grpc.CallOption) (*DevtoolsResponse, error)
}
...
func (c *testClient) Devtools(ctx context.Context, in *DevtoolsRequest, opts ...grpc.CallOption) (*DevtoolsResponse, error) {
	out := new(DevtoolsResponse)
	err := grpc.Invoke(ctx, "/floodchrome.Test/Devtools", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TestServer interface {
	...
	Devtools(context.Context, *DevtoolsRequest) (*DevtoolsResponse, error)
}
...
func _Test_Devtools_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DevtoolsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TestServer).Devtools(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/floodchrome.Test/Devtools",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestServer).Devtools(ctx, req.(*DevtoolsRequest))
	}
...
var _Test_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Devtools",
			Handler:    _Test_Devtools_Handler,
		},
	},
...
func (m *DevtoolsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *DevtoolsRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *DevtoolsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *DevtoolsResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.WsEndpoint) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintControl(dAtA, i, uint64(len(m.WsEndpoint)))
		i += copy(dAtA[i:], m.WsEndpoint)
	}
	return i, nil
}
...
func (m *DevtoolsRequest) Size() (n int) {
	var l int
	_ = l
	return n
}

func (m *DevtoolsResponse) Size() (n int) {
	var l int
	_ = l
	l = len(m.WsEndpoint)
	if l > 0 {
...
func (m *DevtoolsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: DevtoolsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DevtoolsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *DevtoolsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: DevtoolsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DevtoolsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WsEndpoint", wireType)
			}
			...
			m.WsEndpoint = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipControl(dAtA[iNdEx:])
...
var fileDescriptorControl = []byte{
	...
	,
}
